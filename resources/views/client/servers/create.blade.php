...
@section('content')
    ...
    <div class="page-header-breadcrumb mb-3">
        <div class="d-flex align-center justify-content-between flex-wrap">
            <h1 class="page-title fw-medium fs-18 mb-0">Add Server</h1>
                    ...
                    <form action="{{ route('servers.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                @enderror
                                <small class="text-muted">Give your server a descriptive name</small>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                @error('api_key_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Select an API key with view/create/* scopes. The agent will use this for authentication.</small>
                                @if($apiKeys->isEmpty())
                                    <div class="alert alert-warning mt-2">
                                        <i class="ri-alert-line me-2"></i>
                                        No API keys available. <a href="{{ route('api-keys.create') }}">Create an API key</a> first.
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Optional description for this server">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <!-- Server Details (Optional - can be auto-detected by agent) -->
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="card border">
                                    <div class="card-header bg-light">
                                        <div class="card-title mb-0">
                                            <i class="ri-information-line me-2 text-primary"></i>Server Details (Optional)
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <p class="text-muted small mb-3">These fields can be left empty and will be auto-detected by the agent when it first connects.</p>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select @error('os_type') is-invalid @enderror" 
                                                    ...
                                                    <option value="linux" {{ old('os_type') == 'linux' ? 'selected' : '' }}>Linux</option>
                                                    <option value="windows" {{ old('os_type') == 'windows' ? 'selected' : '' }}>Windows</option>
                                                    <option value="macos" {{ old('os_type') == 'macos' ? 'selected' : '' }}>macOS</option>
                                                    <option value="freebsd" {{ old('os_type') == 'freebsd' ? 'selected' : '' }}>FreeBSD</option>
                                                    <option value="other" {{ old('os_type') == 'other' ? 'selected' : '' }}>Other</option>
                                                </select>
                                                @error('os_type')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" class="form-control @error('online_threshold_minutes') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('online_threshold_minutes') }}" 
                                                       min="1" max="1440"
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" class="form-control @error('warning_threshold_minutes') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('warning_threshold_minutes') }}" 
                                                       min="1" max="1440"
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" class="form-control @error('offline_threshold_minutes') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('offline_threshold_minutes') }}" 
                                                       min="1" max="1440"
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary btn-wave" {{ $apiKeys->isEmpty() ? 'disabled' : '' }}>
                                <i class="ri-save-line me-1"></i>Create Server
                            </button>
                        </div>
                    </form>
                </div>
