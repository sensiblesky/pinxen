...
@section('title')
{{ $monitor->name }} - Domain Monitor - PingXeno
@endsection
    ...
    <div class="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('domain-monitors.index') }}">Domain Monitoring</a></li>
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <form action="{{ route('domain-monitors.recheck', $monitor->uid) }}" method="POST" id="recheck-form">
                            @csrf
                            <button type="submit" class="btn btn-info btn-wave w-100">
                                <i class="ri-refresh-line me-1"></i>Recheck WHOIS
                            </button>
                        </form>
                        <a href="{{ route('domain-monitors.edit', $monitor->uid) }}" class="btn btn-primary btn-wave">
                            <i class="ri-pencil-line me-1"></i>Edit Monitor
                        </a>
                        <form action="{{ route('domain-monitors.destroy', $monitor->uid) }}" method="POST" id="delete-form">
                            @csrf
                            @method('DELETE')
