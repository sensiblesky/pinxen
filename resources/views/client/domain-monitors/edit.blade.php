...
@section('title', 'Edit Domain Monitor - PingXeno')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <form action="{{ route('domain-monitors.update', $monitor->uid) }}" method="POST" id="monitor-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('domain-monitors.index') }}" class="btn btn-light btn-wave">
