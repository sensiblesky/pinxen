...
@section('title', 'Uptime Monitoring - PingXeno')
            ...
            <div class="card custom-card">
                <div class="card-header">
                    ...
                    <div class="card-options">
                        <a href="{{ route('uptime-monitors.create') }}" class="btn btn-primary btn-wave btn-sm">
                ...
                <div class="card-body">
                    @if($monitors->isEmpty())
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('uptime-monitors.create') }}" class="btn btn-primary btn-wave">
                                ...
                                <tbody>
                                    @foreach($monitors as $index => $monitor)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-list">
                                                    <a href="{{ route('uptime-monitors.show', $monitor->uid) }}" class="btn btn-sm btn-info btn-wave">
                                                        <i class="ri-eye-line me-1"></i>View
                                                    </a>
                                                    <a href="{{ route('uptime-monitors.edit', $monitor->uid) }}" class="btn btn-sm btn-primary btn-wave">
                                                ...
                                                <form id="delete-form-{{ $monitor->uid }}" action="{{ route('uptime-monitors.destroy', $monitor->uid) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
