...
@section('title')
{{ $monitor->name }} - API Monitor - PingXeno
@endsection
...
@section('content')
    <div class="page-header-breadcrumb mb-3">
        ...
        <div class="btn-list mt-2">
            ...
            <a href="{{ route('api-monitors.edit', $monitor) }}" class="btn btn-primary btn-wave btn-sm">
            ...
            <div class="btn-group btn-sm">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ route('api-monitors.export-checks', $monitor) }}?format=csv"><i class="ri-file-excel-line me-2"></i>Export Checks (CSV)</a></li>
                    <li><a class="dropdown-item" href="{{ route('api-monitors.export-checks', $monitor) }}?format=json"><i class="ri-file-code-line me-2"></i>Export Checks (JSON)</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="{{ route('api-monitors.export-alerts', $monitor) }}?format=csv"><i class="ri-file-excel-line me-2"></i>Export Alerts (CSV)</a></li>
                    <li><a class="dropdown-item" href="{{ route('api-monitors.export-alerts', $monitor) }}?format=json"><i class="ri-file-code-line me-2"></i>Export Alerts (JSON)</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        (function($) {
            $(document).ready(function() {
                ...
                $('#checks-table').DataTable({
                    ...
                    responsive: true,
                    ajax: {
                        url: '{{ route("api-monitors.checks-data", $monitor->uid) }}',
                        type: 'GET'
                    },
                    order: [[6, 'desc']],
                    pageLength: 5,
                ...
                $('#alerts-table').DataTable({
                    ...
                    responsive: true,
                    ajax: {
                        url: '{{ route("api-monitors.alerts-data", $monitor->uid) }}',
                        type: 'GET'
                    },
                    order: [[4, 'desc']],
                    pageLength: 5,
                ...
                $('#test-now-btn').on('click', function() {
                    ...
                    $.ajax({
                        url: '{{ route("api-monitors.test-now", $monitor->uid) }}',
                        type: 'POST',
            ...
            function updateChartRange(range) {
                $.ajax({
                    url: '{{ route("api-monitors.chart-data", $monitor->uid) }}',
                    type: 'GET',
                    data: { range: range },
