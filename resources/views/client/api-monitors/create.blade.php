...
@section('title', 'Create API Monitor - PingXeno')
...
@section('content')
    <div class="page-header-breadcrumb mb-3">
        <div class="d-flex align-center justify-content-between flex-wrap">
            <h1 class="page-title fw-medium fs-18 mb-0">Create API Monitor</h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <form action="{{ route('api-monitors.store') }}" method="POST" id="api-monitor-form">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select class="form-select @error('auth_type') is-invalid @enderror" 
                                            ...
                                            <option value="none" {{ old('auth_type', 'none') == 'none' ? 'selected' : '' }}>None</option>
                                            ...
                                            <option value="apikey" {{ old('auth_type') == 'apikey' ? 'selected' : '' }}>API Key</option>
                                        </select>
                                        @error('auth_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <!-- Bearer Token -->
                                    <div class="col-md-12 mb-3" id="auth_bearer_fields" style="display: {{ old('auth_type') == 'bearer' ? 'block' : 'none' }};">
                                    ...
                                    <!-- Basic Auth -->
                                    <div id="auth_basic_fields" style="display: {{ old('auth_type') == 'basic' ? 'block' : 'none' }};">
                                    ...
                                    <!-- API Key -->
                                    <div id="auth_apikey_fields" style="display: {{ old('auth_type') == 'apikey' ? 'block' : 'none' }};">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('auth_header_name') is-invalid @enderror" 
                                                   id="auth_header_name" name="auth_header_name" value="{{ old('auth_header_name', 'X-API-Key') }}" 
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('auth_token') is-invalid @enderror" 
                                                   id="auth_token_apikey" name="auth_token" value="{{ old('auth_token') }}" 
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('content_type') is-invalid @enderror" 
                                            ...
                                            <option value="application/json" {{ old('content_type', 'application/json') == 'application/json' ? 'selected' : '' }}>application/json</option>
                                            <option value="application/xml" {{ old('content_type') == 'application/xml' ? 'selected' : '' }}>application/xml</option>
                                            <option value="application/x-www-form-urlencoded" {{ old('content_type') == 'application/x-www-form-urlencoded' ? 'selected' : '' }}>application/x-www-form-urlencoded</option>
                                            <option value="text/plain" {{ old('content_type') == 'text/plain' ? 'selected' : '' }}>text/plain</option>
                                        </select>
                                        @error('content_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('request_headers') is-invalid @enderror" 
                                                  ...
                                                  rows="4" 
                                                  placeholder="X-Custom-Header: value&#10;Accept: application/json">{{ old('request_headers') }}</textarea>
                                    ...
                                    <div class="col-md-12 mb-3" id="request_body_section" style="display: {{ in_array(old('request_method', 'GET'), ['POST', 'PUT', 'PATCH']) ? 'block' : 'none' }};">
                                        ...
                                        <textarea class="form-control @error('request_body') is-invalid @enderror" 
                                                  ...
                                                  rows="6" 
                                                  placeholder='{"key": "value"}'>{{ old('request_body') }}</textarea>
                                        @error('request_body')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('max_latency_ms') is-invalid @enderror" 
                                               id="max_latency_ms" name="max_latency_ms" value="{{ old('max_latency_ms') }}" 
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   {{ old('validate_response_body', true) ? 'checked' : '' }}
                                    ...
                                    <div class="col-md-12 mb-3" id="response_assertions_section" style="display: {{ old('validate_response_body', true) ? 'block' : 'none' }};">
                                        ...
                                        <input type="hidden" id="response_assertions" name="response_assertions" value="{{ old('response_assertions') }}">
                                        ...
                                        <div id="json-editor-section" style="display: none;">
                                            <textarea class="form-control @error('response_assertions') is-invalid @enderror" 
                                                      ...
                                                      rows="8" 
                                                      placeholder='[{"type": "json_path", "path": "$.data.user.active", "operator": "==", "value": true}]'>{{ old('response_assertions') }}</textarea>
                        ...
                        <div class="card custom-card mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <div id="stateful_monitoring_section" style="display: {{ old('is_stateful') ? 'block' : 'none' }};">
                                    <!-- Monitoring Steps -->
                                    <div class="mb-4">
                                        ...
                                        <input type="hidden" id="monitoring_steps" name="monitoring_steps" value="{{ old('monitoring_steps') }}">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" id="variable_extraction_rules" name="variable_extraction_rules" value="{{ old('variable_extraction_rules') }}">
                                    </div>
                        ...
                        <div class="card custom-card mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <div id="auto_auth_section" style="display: {{ old('auto_auth_enabled') ? 'block' : 'none' }};">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" id="auto_auth_type" name="auto_auth_type" onchange="toggleAuthTypeFields()">
                                                ...
                                                <option value="oauth2_client_credentials" {{ old('auto_auth_type') == 'oauth2_client_credentials' ? 'selected' : '' }}>OAuth2 Client Credentials</option>
                                                <option value="oauth2_password" {{ old('auto_auth_type') == 'oauth2_password' ? 'selected' : '' }}>OAuth2 Password Grant</option>
                                                <option value="oauth2_refresh_token" {{ old('auto_auth_type') == 'oauth2_refresh_token' ? 'selected' : '' }}>OAuth2 Refresh Token</option>
                                                <option value="jwt" {{ old('auto_auth_type') == 'jwt' ? 'selected' : '' }}>JWT (Extract from Response)</option>
                                                <option value="apikey_rotation" {{ old('auto_auth_type') == 'apikey_rotation' ? 'selected' : '' }}>API Key Rotation Reminder</option>
                                            </select>
                                        </div>
                                        ...
                                        <div id="jwt_fields" style="display: none;">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" class="form-control" 
                                                       ...
                                                       value="{{ old('jwt_expiration_buffer_seconds', 300) }}"
                                                       min="0">
                                        ...
                                        <div id="apikey_rotation_fields" style="display: none;">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" class="form-control" 
                                                       ...
                                                       value="{{ old('apikey_rotation_days') }}"
                                                       min="1">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" 
                                                       ...
                                                       {{ old('auto_refresh_on_expiry', true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" 
                                                       ...
                                                       {{ old('retry_after_refresh', true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" 
                                                   ...
                                                   value="{{ old('max_refresh_attempts', 3) }}"
                                                   min="1" max="10">
                                        </div>
                                    </div>
                        ...
                        <div class="card custom-card mt-3">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   {{ old('schema_drift_enabled') ? 'checked' : '' }}
                                ...
                                <div id="schema_drift_section" style="display: {{ old('schema_drift_enabled') ? 'block' : 'none' }};">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <select class="form-select" id="schema_source_type" name="schema_source_type" onchange="toggleSchemaSource()">
                                                <option value="">Select...</option>
                                                <option value="upload" {{ old('schema_source_type') == 'upload' ? 'selected' : '' }}>Upload OpenAPI/Swagger File</option>
                                                <option value="url" {{ old('schema_source_type') == 'url' ? 'selected' : '' }}>Link to OpenAPI/Swagger URL</option>
                                            </select>
                                        </div>

                                        <!-- Upload Schema -->
                                        <div id="schema_upload_fields" style="display: none;">
                                            <div class="col-md-12 mb-3">
                                        ...
                                        <!-- URL Schema -->
                                        <div id="schema_url_fields" style="display: none;">
                                            <div class="col-md-12 mb-3">
                                        ...
                                        <input type="hidden" id="schema_content" name="schema_content" value="{{ old('schema_content') }}">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" 
                                                       ...
                                                       {{ old('detect_missing_fields', true) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" 
                                                       ...
                                                       {{ old('detect_type_changes', true) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" 
                                                       ...
                                                       {{ old('detect_breaking_changes', true) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" 
                                                       ...
                                                       {{ old('detect_enum_violations', true) ? 'checked' : '' }}>
                                        ...
                                        <!-- Schema Preview -->
                                        <div id="schema_preview" class="col-md-12 mb-3" style="display: none;">
                                            <label class="form-label">Schema Preview</label>
                                            <pre id="schema_preview_content" class="bg-light p-3 rounded" style="max-height: 300px; overflow-y: auto;"></pre>
                                        </div>
                                    </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('api-monitors.index') }}" class="btn btn-light btn-wave">
...
<script>
    ...
    function addConditionalRule() {
        const assertion = {
            ...
            action: {
                type: 'retry', // retry, re_auth, alert
                value: 5, // seconds for retry
                message: ''
            }
        };
        assertions.push(assertion);
