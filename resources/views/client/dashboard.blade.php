...
@section('title', 'Dashboard - PingXeno')
...
<style>
    ...
    /* Ensure flex items respect max-width */
    .top-customers-list .flex-fill {
        flex: 1 1 auto;
        min-width: 0;
        max-width: 200px;
...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 page-header-breadcrumb flex-wrap gap-2">
            ...
            <p class="text-muted mb-0">Comprehensive monitoring overview</p>
        </div>
                    ...
                    <div class="swiper uptime-monitors-swiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ route('uptime-monitors.show', $monitor) }}" class="text-decoration-none">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between">
                                                <div class="flex-fill min-w-0 me-2">
                                                    <span class="d-block text-muted fs-12">URL</span>
                                                    <h6 class="fw-semibold mb-0 url-text" title="{{ $monitor->url }}">{{ $monitor->url }}</h6>
                                                </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 mb-3">
            <a href="{{ route('uptime-monitors.index') }}" class="text-decoration-none">
        ...
        <!-- Domain Monitors -->
        <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 mb-3">
            <a href="{{ route('domain-monitors.index') }}" class="text-decoration-none">
        ...
        <!-- SSL Monitors -->
        <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 mb-3">
            <a href="{{ route('ssl-monitors.index') }}" class="text-decoration-none">
        ...
        <!-- DNS Monitors -->
        <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 mb-3">
            <a href="{{ route('dns-monitors.index') }}" class="text-decoration-none">
        ...
        <!-- API Monitors -->
        <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 mb-3">
            <a href="{{ route('api-monitors.index') }}" class="text-decoration-none">
    ...
    <div class="row mb-4">
        ...
        <div class="col-xxl-3 col-xl-6 boxed-col-3">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <a href="{{ route('uptime-monitors.index') }}" class="text-muted fs-12 text-decoration-underline">View All<i class="ri-arrow-right-line"></i></a>
                </div>
                <div class="card-body">
                    @if($recentUptime->count() > 0)
                                ...
                                <li>
                                    <a href="{{ route('uptime-monitors.show', $monitor) }}" class="text-decoration-none">
                                        ...
                                        <div class="text-end flex-shrink-0">
                                            <div class="fw-semibold {{ $monitor->status === 'up' ? 'text-success' : ($monitor->status === 'down' ? 'text-danger' : 'text-warning') }} mb-0" style="white-space: nowrap;">{{ ucfirst($monitor->status) }}</div>
                        ...
                        <div class="text-center mt-3">
                            <a href="{{ route('uptime-monitors.index') }}" class="btn btn-sm btn-outline-primary">View More</a>
                        </div>
                    @else
                        <div class="p-4 text-center">
                            <p class="text-muted mb-0">No uptime monitors yet</p>
                            <a href="{{ route('uptime-monitors.create') }}" class="btn btn-sm btn-primary mt-2">Create One</a>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-xl-6 boxed-col-3">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <a href="{{ route('domain-monitors.index') }}" class="text-muted fs-12 text-decoration-underline">View All<i class="ri-arrow-right-line"></i></a>
                </div>
                <div class="card-body">
                    @if($recentDomain->count() > 0)
                        <ul class="list-unstyled top-customers-list">
                            @foreach($recentDomain as $monitor)
                                <li>
                                    <a href="{{ route('domain-monitors.show', $monitor) }}" class="text-decoration-none">
                                        <div class="d-flex align-items-center gap-2">
                                        <div class="lh-1 flex-shrink-0">
                        ...
                        <div class="text-center mt-3">
                            <a href="{{ route('domain-monitors.index') }}" class="btn btn-sm btn-outline-primary">View More</a>
                        </div>
                    @else
                        <div class="p-4 text-center">
                            <p class="text-muted mb-0">No domain monitors yet</p>
                            <a href="{{ route('domain-monitors.create') }}" class="btn btn-sm btn-primary mt-2">Create One</a>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-xl-6 boxed-col-3">
                ...
                <div class="card-header justify-content-between">
                    ...
                    <a href="{{ route('ssl-monitors.index') }}" class="text-muted fs-12 text-decoration-underline">View All<i class="ri-arrow-right-line"></i></a>
                </div>
                                <div class="card-body">
                    @if($recentSSL->count() > 0)
                        <ul class="list-unstyled top-customers-list">
                            @foreach($recentSSL as $monitor)
                                <li>
                                    <a href="{{ route('ssl-monitors.show', $monitor) }}" class="text-decoration-none">
                                        <div class="d-flex align-items-center gap-2">
                                        <div class="lh-1 flex-shrink-0">
                        ...
                        <div class="text-center mt-3">
                            <a href="{{ route('ssl-monitors.index') }}" class="btn btn-sm btn-outline-primary">View More</a>
                        </div>
                    @else
                                    <div class="p-4 text-center">
                            <p class="text-muted mb-0">No SSL monitors yet</p>
                            <a href="{{ route('ssl-monitors.create') }}" class="btn btn-sm btn-primary mt-2">Create One</a>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-xl-6 boxed-col-3">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <a href="{{ route('dns-monitors.index') }}" class="text-muted fs-12 text-decoration-underline">View All<i class="ri-arrow-right-line"></i></a>
                </div>
                <div class="card-body">
                    @if($recentDNS->count() > 0)
                        <ul class="list-unstyled top-customers-list">
                            @foreach($recentDNS as $monitor)
                                <li>
                                    <a href="{{ route('dns-monitors.show', $monitor) }}" class="text-decoration-none">
                                        <div class="d-flex align-items-center gap-2">
                                        <div class="lh-1 flex-shrink-0">
                        ...
                        <div class="text-center mt-3">
                            <a href="{{ route('dns-monitors.index') }}" class="btn btn-sm btn-outline-primary">View More</a>
                        </div>
                    @else
                        <div class="p-4 text-center">
                            <p class="text-muted mb-0">No DNS monitors yet</p>
                            <a href="{{ route('dns-monitors.create') }}" class="btn btn-sm btn-primary mt-2">Create One</a>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-xl-6 boxed-col-3">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <a href="{{ route('api-monitors.index') }}" class="text-muted fs-12 text-decoration-underline">View All<i class="ri-arrow-right-line"></i></a>
                </div>
                <div class="card-body">
                    @if($recentAPI->count() > 0)
                        <ul class="list-unstyled top-customers-list">
                            @foreach($recentAPI as $monitor)
                                <li>
                                    <a href="{{ route('api-monitors.show', $monitor) }}" class="text-decoration-none">
                                        <div class="d-flex align-items-center gap-2">
                                        <div class="lh-1 flex-shrink-0">
                        ...
                        <div class="text-center mt-3">
                            <a href="{{ route('api-monitors.index') }}" class="btn btn-sm btn-outline-primary">View More</a>
                        </div>
                    @else
                        <div class="p-4 text-center">
                            <p class="text-muted mb-0">No API monitors yet</p>
                            <a href="{{ route('api-monitors.create') }}" class="btn btn-sm btn-primary mt-2">Create One</a>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-xl-6 boxed-col-3">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <a href="{{ route('servers.index') }}" class="text-muted fs-12 text-decoration-underline">View All<i class="ri-arrow-right-line"></i></a>
                </div>
                <div class="card-body">
                    @if($recentServers->count() > 0)
                        <ul class="list-unstyled top-customers-list">
                            @foreach($recentServers as $server)
                                ...
                                @endphp
                                <li>
                                    <a href="{{ route('servers.show', $server) }}" class="text-decoration-none">
                                        <div class="d-flex align-items-center gap-2">
                                        <div class="lh-1 flex-shrink-0">
                        ...
                        <div class="text-center mt-3">
                            <a href="{{ route('servers.index') }}" class="btn btn-sm btn-outline-primary">View More</a>
                        </div>
                    @else
                        <div class="p-4 text-center">
                            <p class="text-muted mb-0">No servers yet</p>
                            <a href="{{ route('servers.create') }}" class="btn btn-sm btn-primary mt-2">Add Server</a>
                        </div>
                    @endif
                </div>
            </div>
