...
@section('title', 'Create API Key - PingXeno')

@section('content')
    <!-- Start::page-header -->
    <div class="page-header-breadcrumb mb-3">
        <div class="d-flex align-center justify-content-between flex-wrap">
            <h1 class="page-title fw-medium fs-18 mb-0">Create API Key</h1>
        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                <div class="card-header">
                    <div class="card-title">API Key Information</div>
                </div>
                <div class="card-body">
                    <form action="{{ route('api-keys.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                @enderror
                                <small class="text-muted">Give your API key a descriptive name to identify its purpose</small>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" 
                                                           ...
                                                           {{ in_array('view', old('scopes', [])) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="scope_view">
                                                        <strong>View</strong> - Read-only access to view resources
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" 
                                                           ...
                                                           {{ in_array('create', old('scopes', [])) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" 
                                                           ...
                                                           {{ in_array('update', old('scopes', [])) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" 
                                                           ...
                                                           {{ in_array('delete', old('scopes', [])) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" 
                                                           ...
                                                           {{ in_array('*', old('scopes', [])) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="scope_all">
                                                        <strong>All (*)</strong> - Full access to all operations
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                @enderror
                                <small class="text-muted">Select the permissions this API key should have. At least one scope is required.</small>
                            </div>
                        </div>
                                ...
                                <div class="card border">
                                    <div class="card-header bg-light">
                                        <div class="card-title mb-0">
                                            <i class="ri-settings-3-line me-2 text-primary"></i>Advanced Settings (Optional)
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" class="form-control @error('rate_limit') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('rate_limit', 60) }}" min="1" max="10000">
                                                @error('rate_limit')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                                <small class="text-muted">Maximum number of API requests per minute (default: 60)</small>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                @error('allowed_ips')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                                <small class="text-muted">Comma-separated list of IP addresses. Leave empty to allow all IPs.</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // If other scopes are checked, uncheck "All"
        otherScopes.forEach(id => {
