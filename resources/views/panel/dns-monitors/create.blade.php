...
@section('content')
    ...
    <div class="page-header-breadcrumb mb-3">
        <div class="d-flex align-center justify-content-between flex-wrap">
            <h1 class="page-title fw-medium fs-18 mb-0">Create DNS Monitor</h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <form action="{{ route('panel.dns-monitors.store') }}" method="POST" id="monitor-form">
                        @csrf
                                ...
                                <div class="card border">
                                    <div class="card-body">
                                        ...
                                        @php
                                            ...
                                            $oldTypes = old('record_types', ['A', 'AAAA', 'CNAME', 'MX', 'NS', 'TXT', 'SOA']);
                                        @endphp
                                    ...
                                    <div class="card-body">
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   {{ old('alert_on_change', true) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   {{ old('alert_on_missing', true) ? 'checked' : '' }}>
