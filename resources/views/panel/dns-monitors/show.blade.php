    ...
    <div class="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('panel.dns-monitors.index') }}">DNS Monitoring</a></li>
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="d-flex gap-2 flex-wrap">
                        <form action="{{ route('panel.dns-monitors.recheck', $monitor->uid) }}" method="POST" style="display: inline;">
                            @csrf
                            <button type="submit" class="btn btn-primary btn-wave">
                                <i class="ri-refresh-line me-1"></i>Recheck DNS Records
                            </button>
                        </form>
                        <a href="{{ route('panel.dns-monitors.edit', $monitor->uid) }}" class="btn btn-info btn-wave">
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    @if($communicationPreferences->isEmpty())
                        <p class="text-muted">No communication channels configured. <a href="{{ route('panel.dns-monitors.edit', $monitor->uid) }}">Edit monitor</a> to add communication channels.</p>
                    @else
                        <div class="table-responsive">
