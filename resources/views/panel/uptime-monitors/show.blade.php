                ...
                <div class="card-body">
                    ...
                    <div class="border-top pt-2 mt-2">
                        <div class="d-grid gap-2">
                            <a href="{{ route('panel.uptime-monitors.edit', $monitor->uid) }}" class="btn btn-primary btn-wave btn-sm">
...
@section('scripts')
    ...
    <script>
        ...
        // Fetch new chart data
            $.ajax({
                url: '{{ route("panel.uptime-monitors.chart-data", $monitor->uid) }}',
                method: 'GET',
                data: { range: range },
                dataType: 'json',
        ...
        window.applyCustomRange = function() {
            ...
            let url = '{{ route("panel.uptime-monitors.show", $monitor->uid) }}';
        ...
        $(document).ready(function() {
            ...
            $('#checks-table').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: '{{ route("panel.uptime-monitors.checks-data", $monitor->uid) }}',
                    type: 'GET',
                    data: function(d) {
            ...
            $('#alerts-table').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: '{{ route("panel.uptime-monitors.alerts-data", $monitor->uid) }}',
                    type: 'GET',
                    data: function(d) {
                        // Add date range parameters to DataTables request
                        if (startDate) {
