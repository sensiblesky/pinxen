    ...
    @if($latestStat)
        ...
        @if($hasAlerts)
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                ...
                <hr>
                <p class="mb-0">
                    <small>You can adjust these thresholds in the <a href="{{ route('panel.servers.edit', $server) }}" class="alert-link">server settings</a>.</small>
                </p>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        @endif
            ...
            <div class="card custom-card">
                <div class="card-header">
                    ...
                    <div class="card-options">
                        <a href="{{ route('panel.servers.edit', $server) }}" class="btn btn-primary btn-wave btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="btn-list">
                                <a href="{{ route('panel.servers.edit', $server) }}" class="btn btn-primary btn-wave">
                                    <i class="ri-edit-line me-1"></i>Edit
                                </a>
    ...
    (function($) {
        $(document).ready(function() {
            ...
            $('#disk-partitions-table').DataTable({
                ...
                ajax: {
                    url: '{{ route("panel.servers.disk-data", $server->uid) }}',
                    type: 'GET'
                },
                order: [[0, 'asc']],
                pageLength: 5,
            ...
            $('#network-interfaces-table').DataTable({
                ...
                scrollCollapse: false,
                ajax: {
                    url: '{{ route("panel.servers.network-data", $server->uid) }}',
                    type: 'GET'
                },
                order: [[0, 'asc']],
                pageLength: 5,
            ...
            $('#processes-table').DataTable({
                ...
                scrollCollapse: false,
                ajax: {
                    url: '{{ route("panel.servers.processes-data", $server->uid) }}',
                    type: 'GET'
                },
            ...
            $('.chart-range-btn').on('click', function() {
                ...
                if (range) {
                    ...
                    window.location.href = '{{ route("panel.servers.show", $server->uid) }}?range=' + range;
                }
            });
            ...
            window.applyCustomRange = function() {
                ...
                let url = '{{ route("panel.servers.show", $server->uid) }}';
