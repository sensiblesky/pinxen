...
@section('content')
    ...
    <div class="page-header-breadcrumb mb-3">
        <div class="d-flex align-center justify-content-between flex-wrap">
            <h1 class="page-title fw-medium fs-18 mb-0">Edit SSL Monitor</h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <form action="{{ route('panel.ssl-monitors.update', $monitor->uid) }}" method="POST" id="monitor-form">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="card-body">
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   {{ old('alert_expiring_soon', $monitor->alert_expiring_soon) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   {{ old('alert_expired', $monitor->alert_expired) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   {{ old('alert_invalid', $monitor->alert_invalid) ? 'checked' : '' }}>
