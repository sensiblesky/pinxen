        ...
        <div class="col-xl-12">
            ...
            <div class="card custom-card mb-3">
                ...
                <div class="card-body" id="filter-panel">
                    <form method="GET" action="{{ route('panel.ssl-monitors.index') }}" id="search-form">
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3 d-flex align-items-end">
                                ...
                                <a href="{{ route('panel.ssl-monitors.index') }}" class="btn btn-light btn-wave">
            ...
            <div class="card custom-card">
                <div class="card-header">
                    ...
                    <div class="card-options">
                        <a href="{{ route('panel.ssl-monitors.create') }}" class="btn btn-primary btn-wave btn-sm">
                ...
                <div class="card-body">
                    @if($monitors->isEmpty())
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('panel.ssl-monitors.create') }}" class="btn btn-primary btn-wave">
                                ...
                                <tbody>
                                    @foreach($monitors as $index => $monitor)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-list">
                                                    <a href="{{ route('panel.ssl-monitors.show', $monitor->uid) }}" class="btn btn-sm btn-info btn-wave">
                                                        <i class="ri-eye-line"></i>
                                                    </a>
                                                    <a href="{{ route('panel.ssl-monitors.edit', $monitor->uid) }}" class="btn btn-sm btn-primary btn-wave">
                                                        <i class="ri-pencil-line"></i>
                                                    </a>
                                                    <form id="delete-form-{{ $monitor->uid }}" action="{{ route('panel.ssl-monitors.destroy', $monitor->uid) }}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
