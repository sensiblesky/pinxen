...
@section('content')
    ...
    <div class="page-header-breadcrumb mb-3">
        <div class="d-flex align-center justify-content-between flex-wrap">
            <h1 class="page-title fw-medium fs-18 mb-0">Edit External API</h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <form action="{{ route('panel.external-apis.update', $externalApi->id) }}" method="POST" id="api-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                       id="name" name="name" value="{{ old('name', $externalApi->name) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('provider') is-invalid @enderror" 
                                       id="provider" name="provider" value="{{ old('provider', $externalApi->provider) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('service_type') is-invalid @enderror" 
                                    ...
                                    <option value="whois" {{ old('service_type', $externalApi->service_type) == 'whois' ? 'selected' : '' }}>WHOIS</option>
                                    <option value="dns" {{ old('service_type', $externalApi->service_type) == 'dns' ? 'selected' : '' }}>DNS</option>
                                    <option value="ssl" {{ old('service_type', $externalApi->service_type) == 'ssl' ? 'selected' : '' }}>SSL</option>
                                    <option value="geolocation" {{ old('service_type', $externalApi->service_type) == 'geolocation' ? 'selected' : '' }}>Geolocation</option>
                                    <option value="other" {{ old('service_type', $externalApi->service_type) == 'other' ? 'selected' : '' }}>Other</option>
                                </select>
                                @error('service_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="url" class="form-control @error('base_url') is-invalid @enderror" 
                                       id="base_url" name="base_url" value="{{ old('base_url', $externalApi->base_url) }}" 
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control @error('endpoint') is-invalid @enderror" 
                                       id="endpoint" name="endpoint" value="{{ old('endpoint', $externalApi->endpoint) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('api_key') is-invalid @enderror" 
                                       id="api_key" name="api_key" value="{{ old('api_key', $externalApi->api_key) }}" 
                                       placeholder="Enter API key">
                                @error('api_key')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Leave blank to keep existing value. API key will be encrypted when stored.</small>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="api_secret" class="form-label">API Secret</label>
                                <input type="text" class="form-control @error('api_secret') is-invalid @enderror" 
                                       id="api_secret" name="api_secret" value="{{ old('api_secret', $externalApi->api_secret) }}" 
                                       placeholder="Enter API secret (if required)">
                                @error('api_secret')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Leave blank to keep existing value. API secret will be encrypted when stored.</small>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('headers') is-invalid @enderror" 
                                          ...
                                          placeholder='{"apikey": "YOUR_API_KEY"}'>{{ old('headers', $externalApi->headers ? json_encode($externalApi->headers, JSON_PRETTY_PRINT) : '{"apikey": ""}') }}</textarea>
                                @error('headers')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('rate_limit') is-invalid @enderror" 
                                       id="rate_limit" name="rate_limit" value="{{ old('rate_limit', $externalApi->rate_limit) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch mt-4">
                                    <input class="form-check-input" type="checkbox" 
                                           ...
                                           {{ old('is_active', $externalApi->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Optional description">{{ old('description', $externalApi->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary btn-wave">
                                <i class="ri-save-line me-1"></i>Update API
                            </button>
                        </div>
                    </form>
                </div>
