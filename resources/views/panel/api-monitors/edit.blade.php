    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <form action="{{ route('panel.api-monitors.update', $monitor->uid) }}" method="POST" id="api-monitor-form">
                        @csrf
                        @method('PUT')
...
@endif{{ old('request_headers') }}</textarea>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('panel.api-monitors.show', $monitor) }}" class="btn btn-light btn-wave">
