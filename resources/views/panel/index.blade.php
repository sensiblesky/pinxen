...
@section('content')
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
                        <div>
                            <h1 class="page-title fw-medium fs-20 mb-0">Admin Panel</h1>
                        </div>
                                    ...
                                    <div class="card custom-card shadow-none card-bg-primary overflow-hidden dashboard-banner-card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between gap-3">
                                                <div>
                                                    <h5 class="fw-semibold mb-1 text-fixed-white">Hi, {{ Auth::user()->name }} &#128075;</h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked">
                                                            ...
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="{{asset('build/assets/images/ecommerce/jpg/2.jpg')}}" alt="img">
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
